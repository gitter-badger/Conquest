...
public class BitFont {
    ...
    private BitFontSpacingRule defaultRule;
    ...
    public BitFont(Spritesheet glyphBitmap, String charMap, int rows, int columns, Dimension defaultGlyphSize) {
        ...
        this.defaultRule = new BitFontSpacingRule(charMap, defaultGlyphSize.width, 0);
    }

    public static int widthOf(String string, BitFont font) {
        int width = 0;
        for (int i = 0; i < string.length(); i++)
            width += font.getRuleFor(string.charAt(i)).glyphWidth;
        return width;
    }
    ...
    private class BitFontSpacingRule {
         ...
         */
        public int glyphWidth; //for thin letters i,I etc.
        /**
