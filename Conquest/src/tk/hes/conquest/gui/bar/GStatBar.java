...
public class GStatBar extends GBar {
    ...
    public void updateBarBitmaps() {
        switch (type) {
            case RED:
                barBackground = new GImage(Art.UI_BARS.getSprite(0, 0), new Vector2f(0, 0), this);
                barOverlay = new GImage(Art.UI_BARS.getSprite(1, 0), new Vector2f(0, 0), this);
                break;
            case BLUE:
                barBackground = new GImage(Art.UI_BARS.getSprite(0, 1), new Vector2f(0, 0), this);
                barOverlay = new GImage(Art.UI_BARS.getSprite(1, 1), new Vector2f(0, 0), this);
                break;
            case GREEN:
                barBackground = new GImage(Art.UI_BARS.getSprite(0, 2), new Vector2f(0, 0), this);
                barOverlay = new GImage(Art.UI_BARS.getSprite(1, 2), new Vector2f(0, 0), this);
                break;
        }
    }
