...
public class GDialogPart {
    ...
    private Bitmap INFORMATION_POPUP = Art.UI_DIALOG.getSprite(1, 0);
    private Bitmap SUCCESS_POPUP = Art.UI_DIALOG.getSprite(1, 1);
    private Bitmap ERROR_POPUP = Art.UI_DIALOG.getSprite(1, 2);
    private Bitmap WARNING_POPUP = Art.UI_DIALOG.getSprite(1, 3);
